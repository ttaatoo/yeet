...
final class AlacrittyRenderStats: @unchecked Sendable {
    ...
    private static let isEnabled = ProcessInfo.processInfo.environment["YEET_RENDER_STATS"] != nil
    ...
    private func report() {
        ...
        NSLog(String(
            format: "yeet-render drawn=%d skipped=%d rows=%d mean=%.3fms worst=%.3fms",
