...
struct RightSidebarView: View {
    ...
    private var tabBar: some View {
        ...
        // Same 38pt chrome row as MainHeaderView and the project sidebar
        // so the hairline lines up across the window and the pills sit
    ...
    private func scheduleSyncModels() {
        afterViewUpdate { syncModels() }
    }
...
private struct GitPanel: View {
    ...
    var body: some View {
        ...
        .onChange(of: model.repositoryIdentity) {
            afterViewUpdate { resetRepositoryDrafts() }
        }
    ...
    private var moreMenu: some View {
        Menu {
            ...
            Button("Sync Changes") { confirmSyncChanges() }
                .disabled(
    ...
    private func confirmSyncChanges() {
        Task { @MainActor in
            ...
            guard approved else { return }
            performOperation(.moreMenu, model.syncChanges)
        }
    }
