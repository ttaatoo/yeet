...
enum TerminalHistorySerializer {
    ...
    nonisolated private static let restoredBannerSourceLabel = "Session Contents Restored"
    nonisolated static let restoredBannerLabel = String(
    ...
    nonisolated private static let restoredBannerRule = String(repeating: "\u{2500}", count: 4)
    ...
    /// check against it.
    nonisolated private static func restoredBannerText(label: String) -> String {
    ...
    nonisolated private static let restoredBannerTexts: Set<String> = {
...
nonisolated enum TerminalHistoryStore {
